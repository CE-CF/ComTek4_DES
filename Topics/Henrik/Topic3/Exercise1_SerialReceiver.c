...
void generateFrame(int mastersInRange, char *resultFrame, struct Rules rules, int *finalSize){
	...
	// Set the static data of the frame
	...
	// Generating the length + initial static layer 3 data
	...
	// Generating the layer 3 masters data
...
int main(int argc, char *argv[]) {
	...
	frame.data = malloc(testFrame[8] * sizeof(struct Data));
