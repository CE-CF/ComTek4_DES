...
#define BH1750_SENSOR_ADDR 0x13// JDN CONFIG_BH1750_ADDR   /*!< slave address for BH1750 sensor */
#define BH1750_CMD_START 0x12 //JDN CONFIG_BH1750_OPMODE   /*!< Operation mode */
#define ESP_SLAVE_ADDR 0x12 // JDN CONFIG_I2C_SLAVE_ADDRESS //JDN/*!< ESP32 slave address, you can set any 7bit value */
...
static esp_err_t i2c_master_read_slave(i2c_port_t i2c_num, uint8_t *data_rd, size_t size)
{
    ...
    if (size > 1) {
        i2c_master_read(cmd, data_rd, size - 1, (i2c_ack_type_t)ACK_VAL); // JDN typecast
    }
