...
//JDNconst char _pinkyTargetOffset[] = { 4, 0, 0, 4, -4, 0, -4, 4 }; // Includes pinky target bug
const char _pinkyTargetOffset[] = { 4, 0, 0, 4, 0xfc, 0, 0xfc, 4 }; // Includes pinky target bug
